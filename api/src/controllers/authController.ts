            ...
            data: {
                ...
                profile: {
                    create: {
                        ...
                        availabilityDetails: profileData?.availabilityDetails,
                        desiredSalary: profileData?.desiredSalary,
                        crimeConviction: profileData?.crimeConviction,
                        certifications: profileData?.certifications,
                        height: profileData?.height,
                        weight: profileData?.weight,
                        insuranceNumber: profileData?.insuranceNumber,
                        targetDepartments: profileData?.targetDepartments,
                        serviceLocation: profileData?.serviceLocation,
                        servicePreference: profileData?.servicePreference,
                    },
                },
            },
            include: {

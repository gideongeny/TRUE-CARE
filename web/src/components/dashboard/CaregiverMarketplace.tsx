    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between mb-2">
                ...
                <div className="bg-teal-50 text-teal-600 px-3 py-1.5 rounded-full text-xs font-bold border border-teal-100 flex items-center gap-2">
                        ...
                        {openShifts.map((shift) => (
                            ...
                            >
                                <div className="absolute top-0 right-0 p-4">
                                    <div className="bg-teal-50 text-teal-600 px-2 py-1 rounded-lg text-[10px] font-bold uppercase tracking-widest border border-teal-100">
                                        Open Request
                                    </div>
                                </div>

                                <div className="flex items-start gap-4 mb-6">
                                    <div className="w-14 h-14 bg-slate-50 rounded-2xl flex items-center justify-center border border-slate-100 group-hover:bg-teal-600 transition-colors">
                                ...
                                <div className="space-y-4 mb-8">
                                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                        <p className="text-[9px] font-bold text-teal-600 uppercase tracking-[0.2em] mb-2">Patient Intelligence</p>
                                ...
                                <button
                                    ...
                                    className={`
                                        w-full py-4 rounded-2xl text-[11px] font-bold uppercase tracking-[0.2em] transition-all
                                        ${claiming === shift.id
                                            ? 'bg-slate-100 text-slate-400 cursor-not-allowed'
                                            : 'bg-teal-600 text-white hover:bg-teal-500 shadow-xl shadow-teal-600/20 hover:shadow-teal-500/30'}
                                    `}
                                >
